...
public class DoctorControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            if(userid==null || usertype.equalsIgnoreCase("patient") || usertype.equalsIgnoreCase("admin"))
            {
                sess.invalidate();
            ...
            if(usertype.equalsIgnoreCase("doctor"))
            {
                ...
                Blob img=RegistrationDao.getDoctorsImage(userid);
                if(img!=null)
                    d.setdImage(img);
                sess.setAttribute("image",d);
