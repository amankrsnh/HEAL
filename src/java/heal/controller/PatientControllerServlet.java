...
public class PatientControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            if(userid==null || usertype.equalsIgnoreCase("doctor") || usertype.equalsIgnoreCase("admin"))
            {
                sess.invalidate();
            ...
            if(usertype.equalsIgnoreCase("patient"))
            {
                ...
                Blob img=RegistrationDao.getPatientsImage(userid);
                if(img!=null)
                    p.setpImage(img);
                sess.setAttribute("image",p);
